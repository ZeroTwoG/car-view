            ...
            <van-pull-refresh v-model="isLoading" @refresh="onRefresh">
                ...
                <div v-for="item in evaluateDetail">
                    <van-row style="margin-top: 20px; font-size: 12px">
                        <van-col span="4">
                            <van-image round width="2rem" height="2rem" :src="item.imageUrl"
                        ...
                        <van-col span="14">
                            ...
                            <van-row>
                                <van-rate size="10px" allow-half v-model="item.rating" readonly
                    ...
                    <div v-if="item.img !== '' & item.img != null" v-for="items in item.img">
                        <van-row style="margin-left: 30px">
                            <img :src="items.imageUrl" width="90px" height="90px"
                                style="border: 1px solid rgba(157,157,157,0.1);border-radius: 5px" />
                        </van-row>
                    </div>
