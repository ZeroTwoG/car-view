    ...
    <div>
        ...
        <div class="second">
          ...
          <span style="font-size: 20px">总计：<span
                  v-if="integral != '0'" style="color: red; font-weight: bold; font-size: 22px">{{integral}}</span>
            <span style="color: red; font-weight: bold; font-size: 16px">{{priceValue}}</span>
              ...
              <span v-if="sumPrice != '0'" style="color: red; font-weight: bold; font-size: 22px">{{ sumPrice }}</span>
