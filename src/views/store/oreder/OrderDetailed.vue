<template>
    <div>
        <van-sticky>
            <van-nav-bar style="height: 65px" title="订单详情" left-arrow @click-left="onClickLeft" />
        </van-sticky>
        ...
        <van-row>
            <van-col span="24">
                <van-card :num="productOrder.productCount" :price="productOrder.newPrice">
                    <van-image slot="thumb" width="100%" height="10rem" fit="cover" :src="productOrder.picture" />
