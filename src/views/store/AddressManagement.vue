<template>
  <div>
    <van-sticky>
      <van-nav-bar title="收货地址" left-arrow @click-left="onClickLeft('my')" />
    </van-sticky>
    <van-address-list v-model="chosenAddressId" :list="allAddress" default-tag-text="默认" @add="onAdd" @edit="onEdit" />
  </div>
</template>
