  ...
  <div>
    ...
    <van-pull-refresh v-model="isLoading" @refresh="onRefresh">
      ...
      <van-swipe class="my-swipe" :autoplay="1500" indicator-color="white">
        <van-swipe-item v-for="(image) in imgs">
      ...
      <van-row class="weather">
        <van-col span="5">
          <!-- 城市 -->
          <van-icon name="location-o" color="blue" @click="dialogVisible = true" />
      ...
      <!-- 高德地图 -->
      <el-dialog title="查看附近位置信息(维护中)" :visible.sync="dialogVisible" width="100%" :before-close="handleClose">
      ...
      <div id="storeDetail">
        <van-row style="margin-top: 15px; margin-bottom: 10px;margin-left: 8px">
          ...
          <van-col span="4">
            <!-- 导航栏 -->
            <a @click="jump('/nearbyShop')" style="text-decoration: none; color: #019FE8">更多</a>
      ...
      <van-tabbar v-model="active" active-color="#ee0a24">
        <van-tabbar-item name="home" icon="coupon" @click="jump('/index')">
          主页
        </van-tabbar-item>
        <van-tabbar-item name="search" icon="location" @click="jump('/nearbyShop')">
          附近门店
        </van-tabbar-item>
        <van-tabbar-item name="shop" icon="shopping-cart" @click="jump('/shopping')">
          商城
        </van-tabbar-item>
        <van-tabbar-item name="my" icon="contact" @click="jump('/myCenter')">
          我的
        </van-tabbar-item>
      </van-tabbar>
    </van-pull-refresh>
...
export default {
  data() {
    return {
      ...
      // 轮播图
      imgs: [
        require('@/assets/indexImg/1.jpg'), // 使用Vue CLI的别名
        require('@/assets/indexImg/2.jpg'),
        require('@/assets/indexImg/3.jpg')
      ],
      // 控制高德地图的显示
      dialogVisible: false,
      //高德地图的key
